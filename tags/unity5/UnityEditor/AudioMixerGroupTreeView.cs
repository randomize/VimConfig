    ...
    internal class AudioMixerGroupTreeView
    {
        ...
        public void OnGUI(Rect rect)
        {
            ...
            if (this.m_Controller != null)
            {
                ...
                AudioMixerDrawUtils.DrawScrollDropShadow(rect3, this.m_AudioGroupTree.state.scrollPos.y, this.m_AudioGroupTree.gui.GetTotalSize(this.m_AudioGroupTree.data.GetVisibleRows()).y);
