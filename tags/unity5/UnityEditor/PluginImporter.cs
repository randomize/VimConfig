namespace UnityEditor
{
    ...
    public sealed class PluginImporter : AssetImporter
    {
        ...
        {
            <GetImporters>c__AnonStoreyE ye = new <GetImporters>c__AnonStoreyE {
                platformName = platformName
            };
            return GetAllImporters().Where<PluginImporter>(new Func<PluginImporter, bool>(ye.<>m__10)).ToArray<PluginImporter>();
        }
        ...
        [CompilerGenerated]
        private sealed class <GetExtensionPlugins>c__Iterator0 : IEnumerable<PluginDesc>, IEnumerator<PluginDesc>, IDisposable, IEnumerable, IEnumerator
        {
            internal PluginDesc $current;
            internal int $PC;
            internal BuildTarget <$>target;
            internal IEnumerator<IEnumerable<PluginDesc>> <$s_89>__1;
            internal IEnumerator<PluginDesc> <$s_90>__3;
                ...
                switch (num)
                {
                    case 1:
                        try
                        {
                            ...
                            {
                                if (this.<$s_90>__3 == null)
                                {
                                }
                                this.<$s_90>__3.Dispose();
                            }
                        }
                        finally
                        {
                            if (this.<$s_89>__1 == null)
                            {
                            }
                            this.<$s_89>__1.Dispose();
                        }
                        break;
                }
            }
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                    {
                        ...
                        this.<$s_89>__1 = this.<pluginDescriptions>__0.GetEnumerator();
                        num = 0xfffffffd;
                        break;
                    }
                    case 1:
                ...
                try
                {
                    ...
                    while (this.<$s_89>__1.MoveNext())
                    {
                        this.<extensionPlugins>__2 = this.<$s_89>__1.Current;
                        this.<$s_90>__3 = this.<extensionPlugins>__2.GetEnumerator();
                        num = 0xfffffffd;
                    Label_0096:
                        try
                        {
                            while (this.<$s_90>__3.MoveNext())
                            {
                                this.<pluginDesc>__4 = this.<$s_90>__3.Current;
        ...
        [CompilerGenerated]
        private sealed class <GetImporters>c__AnonStoreyE
        {
            internal string platformName;

            internal bool <>m__10(PluginImporter imp)
            {
