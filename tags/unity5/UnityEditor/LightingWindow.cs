    ...
    internal class LightingWindow : EditorWindow
    {
        ...
        private void GeneralSettingsGUI(SerializedObject so, SerializedProperty enableRealtimeGI, SerializedProperty enableBakedGI)
        {
            ...
            if (this.m_ShowGeneralSettings)
            {
                ...
                EditorGUI.BeginDisabledGroup(!flag);
                EditorGUI.indentLevel++;
                EditorGUILayout.IntPopup(property5, this.kModeStrings, this.kModeValues, s_Styles.DirectionalMode, new GUILayoutOption[0]);
                if (property5.intValue == 2)
                {
                ...
                EditorGUILayout.IntPopup(property3, this.kMaxAtlasSizeStrings, this.kMaxAtlasSizeValues, styles.MaxAtlasSize, new GUILayoutOption[0]);
