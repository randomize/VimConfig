namespace UnityEditor
{
    ...
    {
        [CompilerGenerated]
        private static Func<Assembly, IEnumerable<System.Type>> <>f__am$cache2;
        private readonly string[] names;
        private readonly int[] values;

        public MaterialEnumDrawer(string enumName)
        {
            <MaterialEnumDrawer>c__AnonStorey86 storey = new <MaterialEnumDrawer>c__AnonStorey86 {
                enumName = enumName
            };
            if (<>f__am$cache2 == null)
            {
                <>f__am$cache2 = new Func<Assembly, IEnumerable<System.Type>>(MaterialEnumDrawer.<MaterialEnumDrawer>m__155);
            }
            System.Type[] source = AppDomain.CurrentDomain.GetAssemblies().SelectMany<Assembly, System.Type>(<>f__am$cache2).ToArray<System.Type>();
            try
            {
                System.Type enumType = source.FirstOrDefault<System.Type>(new Func<System.Type, bool>(storey.<>m__156));
        ...
        [CompilerGenerated]
        private static IEnumerable<System.Type> <MaterialEnumDrawer>m__155(Assembly x)
        {
        ...
        [CompilerGenerated]
        private sealed class <MaterialEnumDrawer>c__AnonStorey86
        {
            internal string enumName;

            internal bool <>m__156(System.Type x)
            {
