namespace UnityEditor
{
    ...
    internal class FlexibleMenu : PopupWindowContent
    {
        ...
        {
            <EditExistingItem>c__AnonStorey6C storeyc = new <EditExistingItem>c__AnonStorey6C {
                index = index,
                <>f__this = this
            };
            if (this.m_ModifyItemUI != null)
            {
                ...
                this.m_ModifyItemUI.Init(FlexibleMenuModifyItemUI.MenuType.Edit, this.m_ItemProvider.GetItem(storeyc.index), new Action<object>(storeyc.<>m__F4));
        ...
        [CompilerGenerated]
        private sealed class <EditExistingItem>c__AnonStorey6C
        {
            internal FlexibleMenu <>f__this;
            internal int index;

            internal void <>m__F4(object obj)
            {
