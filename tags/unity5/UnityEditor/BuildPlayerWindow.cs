        ...
        private class Styles
        {
            ...
            public Styles()
            {
                GUIContent[] contentArray1 = new GUIContent[,] { 
                    { EditorGUIUtility.TextContent("Unity Web Player building is disabled during the public preview beta. It will be enabled when Unity ships."), new GUIContent(string.Empty), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Standalone Publishing."), new GUIContent(string.Empty), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover iOS Publishing."), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Android Publishing."), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover BlackBerry Publishing."), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Tizen Publishing."), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Xbox 360 Publishing."), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover Xbox One Publishing."), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover PS3 Publishing."), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover PS Vita Publishing."), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover PS4 Publishing."), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover GLESEmu Publishing"), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover Wii U Publishing."), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }, { EditorGUIUtility.TextContent("Your license does not cover Flash Publishing"), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Windows Store Publishing."), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Windows Phone 8 Publishing."), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, 
                    { EditorGUIUtility.TextContent("Your license does not cover SamsungTV Publishing"), EditorGUIUtility.TextContent("Go to Our Online Store"), new GUIContent("https://store.unity3d.com/shop/") }, { EditorGUIUtility.TextContent("Your license does not cover Nintendo 3DS Publishing"), EditorGUIUtility.TextContent("Contact sales"), new GUIContent("http://unity3d.com/company/sales?type=sales") }
                 };
                this.notLicensedMessages = contentArray1;
                GUIContent[] contentArray2 = new GUIContent[0x12, 3];
                ...
                contentArray2[4, 0] = EditorGUIUtility.TextContent("BlackBerry is not supported in this build.\nDownload a build that supports it.");
                contentArray2[4, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[5, 0] = EditorGUIUtility.TextContent("Tizen is not supported in this build.\nDownload a build that supports it.");
                contentArray2[5, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[6, 0] = EditorGUIUtility.TextContent("Xbox 360 Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[6, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[7, 0] = EditorGUIUtility.TextContent("Xbox One Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[7, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[8, 0] = EditorGUIUtility.TextContent("PS3 Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[8, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[9, 0] = EditorGUIUtility.TextContent("PS Vita Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[9, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[10, 0] = EditorGUIUtility.TextContent("PS4 Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[10, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[11, 0] = EditorGUIUtility.TextContent("GLESEmu Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[11, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[12, 0] = EditorGUIUtility.TextContent("Wii U Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[12, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[13, 0] = EditorGUIUtility.TextContent("Flash Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[13, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[14, 0] = EditorGUIUtility.TextContent("Windows Store Player is not supported in\nthis build.\n\nDownload a build that supports it.");
                contentArray2[14, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[15, 0] = EditorGUIUtility.TextContent("Windows Phone 8 Player is not supported\nin this build.\n\nDownload a build that supports it.");
                contentArray2[15, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[0x10, 0] = EditorGUIUtility.TextContent("SamsungTV Player is not supported in this build.\nDownload a build that supports it.");
                contentArray2[0x10, 2] = new GUIContent("http://unity3d.com/unity/download/");
                contentArray2[0x11, 0] = EditorGUIUtility.TextContent("Ninteno 3DS is not supported in this build.\nDownload a build that supports it.");
