namespace UnityEditor
{
    ...
    internal class CameraEditor : Editor
    {
        ...
        private static readonly GUIContent[] kTargetEyes = new GUIContent[] { new GUIContent("Both"), new GUIContent("Left"), new GUIContent("Right") };
        private static readonly int[] kTargetEyeValues = new int[] { 3, 1, 2 };
        ...
        private static readonly GUIContent[] s_GameDisplays = new GUIContent[] { new GUIContent("Display 1"), new GUIContent("Display 2"), new GUIContent("Display 3"), new GUIContent("Display 4"), new GUIContent("Display 5"), new GUIContent("Display 6"), new GUIContent("Display 7"), new GUIContent("Display 8") };
        private static readonly int[] s_GameDisplayValues = new int[] { 0, 1, 2, 3, 4, 5, 6, 7 };
        ...
        {
            GUIContent[] displayNames = ModuleManager.GetDisplayNames(EditorUserBuildSettings.activeBuildTarget.ToString());
            return (Display.MultiDisplayLicense() || (displayNames != null));
        }
