namespace UnityEditor.Sprites
{
    ...
    {
        [CompilerGenerated]
        private static Func<System.Type, string> <>f__am$cache4;
        ...
        private static void RegenerateList()
        {
            if (m_policies == null)
            {
                ...
                m_policies = source.Select<System.Type, string>(<>f__am$cache4).ToArray<string>();
                m_policyTypeCache = new Dictionary<string, System.Type>();
                foreach (System.Type type2 in source)
                {
