namespace UnityEditor
{
    ...
    internal class GccCompiler : NativeCompiler
    {
        ...
        {
            <CompileDynamicLibrary>c__AnonStorey65 storey = new <CompileDynamicLibrary>c__AnonStorey65 {
                <>f__this = this
            };
            ...
            storey.includeDirs = includePaths.Aggregate<string, string>(string.Empty, <>f__am$cache1);
            string str = string.Empty;
            string str2 = NativeCompiler.Aggregate(libraryPaths.Union<string>(this.m_Settings.LibPaths), "-L", " ");
            NativeCompiler.ParallelFor<string>(strArray, new Action<string>(storey.<>m__D5));
        ...
        [CompilerGenerated]
        private sealed class <CompileDynamicLibrary>c__AnonStorey65
        {
            internal GccCompiler <>f__this;
            internal string includeDirs;

            internal void <>m__D5(string file)
            {
