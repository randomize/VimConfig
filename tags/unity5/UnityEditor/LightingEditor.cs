    ...
    internal class LightingEditor : Editor
    {
        ...
        internal class Styles
        {
            ...
            static Styles()
            {
                ...
                {
                    <>f__am$cache16 = new Func<int, GUIContent>(LightingEditor.Styles.<defaultReflectionSizes>m__1D8);
                }
                defaultReflectionSizes = defaultReflectionSizesValues.Select<int, GUIContent>(<>f__am$cache16).ToArray<GUIContent>();
            }

            [CompilerGenerated]
            private static GUIContent <defaultReflectionSizes>m__1D8(int n)
            {
