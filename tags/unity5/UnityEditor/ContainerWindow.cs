namespace UnityEditor
{
    ...
    internal sealed class ContainerWindow : ScriptableObject
    {
        ...
        {
            return INTERNAL_CALL_FitWindowRectToScreen(this, ref r, forceCompletelyVisible, useMouseScreen);
        }
        ...
        {
            return INTERNAL_CALL_FitRectToScreen(ref defaultRect, forceCompletelyVisible, useMouseScreen);
        }
