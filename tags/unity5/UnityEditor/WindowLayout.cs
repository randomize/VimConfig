namespace UnityEditor
{
    ...
    internal class WindowLayout
    {
        ...
        public static void CloseWindows()
        {
            ...
            UnityEngine.Object[] objArray3 = Resources.FindObjectsOfTypeAll(typeof(EditorWindow));
            ...
            UnityEngine.Object[] objArray5 = Resources.FindObjectsOfTypeAll(typeof(View));
        ...
        {
            UnityEngine.Object[] objArray = Resources.FindObjectsOfTypeAll(type);
        ...
        {
            UnityEngine.Object[] objArray = Resources.FindObjectsOfTypeAll(typeof(MainWindow));
            if (objArray.Length == 0)
            {
        ...
        {
            UnityEngine.Object[] objArray = Resources.FindObjectsOfTypeAll(typeof(MaximizedHostView));
            if (objArray.Length != 0)
            {
        ...
        public static bool LoadWindowLayout(string path, bool newProjectLayoutWasCreated)
        {
            ...
            try
            {
                ...
                foreach (UnityEngine.Object obj2 in objArray3)
                {
                ...
                int num3 = 0;
                foreach (UnityEngine.Object obj3 in objArray3)
                {
                    if (obj3 == null)
                    {
                        UnityEngine.Debug.LogError("Error while reading window layout: window #" + num3 + " is null");
                        throw new Exception();
                    }
                    if (obj3.GetType() == null)
                    {
                        UnityEngine.Debug.LogError(string.Concat(new object[] { "Error while reading window layout: window #", num3, " type is null, instanceID=", obj3.GetInstanceID() }));
                        throw new Exception();
                    }
                ...
                foreach (UnityEngine.Object obj4 in objArray3)
                {
        ...
        public static void SaveWindowLayout(string path)
        {
            TooltipView.Close();
            ArrayList list = new ArrayList();
            UnityEngine.Object[] objArray = Resources.FindObjectsOfTypeAll(typeof(EditorWindow));
            UnityEngine.Object[] objArray2 = Resources.FindObjectsOfTypeAll(typeof(ContainerWindow));
            UnityEngine.Object[] objArray3 = Resources.FindObjectsOfTypeAll(typeof(View));
        ...
        [CompilerGenerated]
        private sealed class <FindEditorWindowsOfType>c__Iterator6<T> : IDisposable, IEnumerable, IEnumerator, IEnumerable<T>, IEnumerator<T> where T: class
        {
            internal T $current;
            internal int $PC;
            internal UnityEngine.Object[] <$s_1022>__0;
            internal int <$s_1023>__1;
            ...
            public bool MoveNext()
            {
                ...
                {
                    case 0:
                        this.<$s_1022>__0 = Resources.FindObjectsOfTypeAll(typeof(T));
                        this.<$s_1023>__1 = 0;
                        goto Label_009A;
            ...
            Label_008C:
                this.<$s_1023>__1++;
            Label_009A:
                if (this.<$s_1023>__1 < this.<$s_1022>__0.Length)
                {
                    this.<obj>__2 = this.<$s_1022>__0[this.<$s_1023>__1];
