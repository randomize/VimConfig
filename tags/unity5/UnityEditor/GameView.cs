namespace UnityEditor
{
    ...
    internal class GameView : EditorWindow
    {
        ...
        private static GUIContent[] s_GameDisplays = new GUIContent[] { EditorGUIUtility.TextContent("Display 1"), EditorGUIUtility.TextContent("Display 2"), EditorGUIUtility.TextContent("Display 3"), EditorGUIUtility.TextContent("Display 4"), EditorGUIUtility.TextContent("Display 5"), EditorGUIUtility.TextContent("Display 6"), EditorGUIUtility.TextContent("Display 7"), EditorGUIUtility.TextContent("Display 8") };
        ...
        private void DoToolbarGUI()
        {
            ...
            if (this.ShouldShowMultiDisplayOption())
            {
                ...
                int num = EditorGUILayout.Popup(this.m_TargetDisplay, this.GetDisplayNames(), EditorStyles.toolbarPopup, optionArray1);
