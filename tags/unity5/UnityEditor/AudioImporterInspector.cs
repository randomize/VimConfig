namespace UnityEditor
{
    ...
    internal class AudioImporterInspector : AssetImporterInspector
    {
        ...
        [CompilerGenerated]
        private sealed class <GetAllAudioImporterTargets>c__Iterator7 : IDisposable, IEnumerable, IEnumerator, IEnumerable<AudioImporter>, IEnumerator<AudioImporter>
        {
            internal AudioImporter $current;
            internal int $PC;
            internal UnityEngine.Object[] <$s_1098>__0;
            internal int <$s_1099>__1;
            ...
            public bool MoveNext()
            {
                ...
                {
                    case 0:
                        this.<$s_1098>__0 = this.<>f__this.targets;
                        this.<$s_1099>__1 = 0;
                        goto Label_0099;
            ...
            Label_008B:
                this.<$s_1099>__1++;
            Label_0099:
                if (this.<$s_1099>__1 < this.<$s_1098>__0.Length)
                {
                    this.<importer>__2 = this.<$s_1098>__0[this.<$s_1099>__1];
