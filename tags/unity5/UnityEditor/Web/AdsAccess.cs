namespace UnityEditor.Web
{
    ...
    internal class AdsAccess : CloudServiceAccess
    {
        ...
        private const string kServiceUrl = "http://public.cloud.unity3d.com/editor/5.2/production/cloud/ads";

        static AdsAccess()
        {
            UnityConnectServiceData cloudService = new UnityConnectServiceData("Unity Ads", "http://public.cloud.unity3d.com/editor/5.2/production/cloud/ads", new AdsAccess(), "unity/project/cloud/ads");
