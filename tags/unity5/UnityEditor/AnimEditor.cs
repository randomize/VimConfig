namespace UnityEditor
{
    ...
    internal class AnimEditor : ScriptableObject
    {
        ...
        private void HandleCopyPaste()
        {
            if ((Event.current.type == EventType.ValidateCommand) || (Event.current.type == EventType.ExecuteCommand))
            {
                ...
                if (commandName != null)
                {
                    ...
                    if (<>f__switch$map9.TryGetValue(commandName, out num))
                    {
                        if (num == 0)
                        {
        ...
        public void OnDisable()
        {
            ...
            this.m_State.onClipSelectionChanged = (System.Action) Delegate.Remove(this.m_State.onClipSelectionChanged, new System.Action(this.OnClipSelectionChange));
        ...
        public void OnEnable()
        {
            ...
            this.m_State.onClipSelectionChanged = (System.Action) Delegate.Combine(this.m_State.onClipSelectionChanged, new System.Action(this.OnClipSelectionChange));
