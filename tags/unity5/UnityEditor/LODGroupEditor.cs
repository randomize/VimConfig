namespace UnityEditor
{
    ...
    internal class LODGroupEditor : Editor
    {
        ...
        [CompilerGenerated]
        private static Func<UnityEngine.Object, GameObject> <>f__am$cache12;
        [CompilerGenerated]
        private static Func<UnityEngine.Object, bool> <>f__am$cache13;
        [CompilerGenerated]
        private static Func<UnityEngine.Object, Renderer> <>f__am$cache14;
        [CompilerGenerated]
        ...
        [CompilerGenerated]
        private static Func<UnityEngine.Object, bool> <>f__am$cache19;
        [CompilerGenerated]
        private static Func<UnityEngine.Object, GameObject> <>f__am$cache1A;
        [CompilerGenerated]
                        ...
                        if (lODLevel >= -1)
                        {
                            ...
                            if (DragAndDrop.objectReferences.Count<UnityEngine.Object>() > 0)
                            {
                                ...
                                if (current.type == EventType.DragPerform)
                                {
                                    ...
                                    IEnumerable<GameObject> selectedGameObjects = DragAndDrop.objectReferences.Where<UnityEngine.Object>(<>f__am$cache19).Select<UnityEngine.Object, GameObject>(<>f__am$cache1A);
        ...
        {
            <GetRenderers>c__AnonStorey84 storey = new <GetRenderers>c__AnonStorey84 {
                lodGroup = this.target as LODGroup
            };
            if ((storey.lodGroup == null) || EditorUtility.IsPersistent(storey.lodGroup))
            {
                return new List<Renderer>();
            }
            IEnumerable<GameObject> first = selectedGameObjects.Where<GameObject>(new Func<GameObject, bool>(storey.<>m__149));
            IEnumerable<GameObject> source = selectedGameObjects.Where<GameObject>(new Func<GameObject, bool>(storey.<>m__14A));
            ...
            if ((source.Count<GameObject>() > 0) && EditorUtility.DisplayDialog("Reparent GameObjects", "Some objects are not children of the LODGroup GameObject. Do you want to reparent them and add them to the LODGroup?", "Yes, Reparent", "No, Use Only Existing Children"))
            {
                ...
                try
                {
                    while (enumerator.MoveNext())
                    {
                        ...
                        {
                            GameObject item = UnityEngine.Object.Instantiate<GameObject>(current);
                            if (item != null)
                            {
                                item.transform.parent = storey.lodGroup.transform;
                        ...
                        {
                            current.transform.parent = storey.lodGroup.transform;
                            second.Add(current);
                        }
                    }
                }
            ...
            IEnumerable<Renderer> collection = DragAndDrop.objectReferences.Where<UnityEngine.Object>(<>f__am$cache13).Select<UnityEngine.Object, Renderer>(<>f__am$cache14);
        ...
        {
            <HandleAddRenderer>c__AnonStorey83 storey = new <HandleAddRenderer>c__AnonStorey83 {
                evt = Event.current
            };
            switch (storey.evt.type)
            {
                case EventType.Repaint:
                ...
                {
                    bool flag = false;
                    if (drawArea.Contains(storey.evt.mousePosition) && alreadyDrawn.All<Rect>(new Func<Rect, bool>(storey.<>m__146)))
                    {
                        flag = true;
                    }
                    if (flag)
                    {
                        ...
                        IEnumerable<GameObject> selectedGameObjects = DragAndDrop.objectReferences.Where<UnityEngine.Object>(<>f__am$cache11).Select<UnityEngine.Object, GameObject>(<>f__am$cache12);
                        IEnumerable<Renderer> renderers = this.GetRenderers(selectedGameObjects, true);
                        this.AddGameObjectRenderers(renderers, true);
                        DragAndDrop.AcceptDrag();
                        storey.evt.Use();
                ...
                case EventType.MouseDown:
                    if (position.Contains(storey.evt.mousePosition))
                    {
                        storey.evt.Use();
        ...
        [CompilerGenerated]
        private sealed class <GetRenderers>c__AnonStorey84
        {
            internal LODGroup lodGroup;

            internal bool <>m__149(GameObject go)
            {
                return go.transform.IsChildOf(this.lodGroup.transform);
            }

            internal bool <>m__14A(GameObject go)
            {
                return !go.transform.IsChildOf(this.lodGroup.transform);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <HandleAddRenderer>c__AnonStorey83
        {
            internal Event evt;

            internal bool <>m__146(Rect x)
            {
