namespace UnityEditor
{
    ...
    internal class AssemblyHelper
    {
        ...
        {
            <AddReferencedAssembliesRecurse>c__AnonStorey26 storey = new <AddReferencedAssembliesRecurse>c__AnonStorey26 {
                target = target
            };
            if (!IgnoreAssembly(assemblyPath, storey.target))
            {
                ...
                if (alreadyFoundAssemblies.IndexOf(assemblyPath) == -1)
                {
                    ...
                    IEnumerable<string> source = PluginImporter.GetImporters(storey.target).Where<PluginImporter>(new Func<PluginImporter, bool>(storey.<>m__31)).Select<PluginImporter, string>(<>f__am$cache0).Distinct<string>();
                    <AddReferencedAssembliesRecurse>c__AnonStorey27 storey2 = new <AddReferencedAssembliesRecurse>c__AnonStorey27();
                    using (Collection<AssemblyNameReference>.Enumerator enumerator = assemblyDefinitionCached.MainModule.AssemblyReferences.GetEnumerator())
                    {
                        ...
                        {
                            storey2.referencedAssembly = enumerator.Current;
                            if (((storey2.referencedAssembly.Name != "BridgeInterface") && (storey2.referencedAssembly.Name != "WinRTBridge")) && ((storey2.referencedAssembly.Name != "UnityEngineProxy") && !IgnoreAssembly(storey2.referencedAssembly.Name + ".dll", storey.target)))
                            {
                                ...
                                {
                                    bool flag = false;
                                    <AddReferencedAssembliesRecurse>c__AnonStorey28 storey3 = new <AddReferencedAssembliesRecurse>c__AnonStorey28 {
                                        <>f__ref$39 = storey2
                                    };
                                    string[] strArray = new string[] { ".dll", ".winmd" };
                                    for (int j = 0; j < strArray.Length; j++)
                                    {
                                        storey3.extension = strArray[j];
                                        if (source.Any<string>(new Func<string, bool>(storey3.<>m__33)))
                                        {
                                            flag = true;
                                            break;
                                        }
        ...
        [CompilerGenerated]
        private sealed class <AddReferencedAssembliesRecurse>c__AnonStorey26
        {
            internal BuildTarget target;

            internal bool <>m__31(PluginImporter i)
            {
        ...
        [CompilerGenerated]
        private sealed class <AddReferencedAssembliesRecurse>c__AnonStorey27
        {
            internal AssemblyNameReference referencedAssembly;
        }

        [CompilerGenerated]
        private sealed class <AddReferencedAssembliesRecurse>c__AnonStorey28
        {
            internal AssemblyHelper.<AddReferencedAssembliesRecurse>c__AnonStorey27 <>f__ref$39;
            internal string extension;

            internal bool <>m__33(string p)
            {
                return string.Equals(p, this.<>f__ref$39.referencedAssembly.Name + this.extension, StringComparison.InvariantCultureIgnoreCase);
            }
        }

        [CompilerGenerated]
        private sealed class <FindImplementors>c__Iterator2<T> : IDisposable, IEnumerable, IEnumerator, IEnumerable<T>, IEnumerator<T> where T: class
        {
            internal T $current;
            internal int $PC;
            internal Assembly <$>assembly;
            internal System.Type[] <$s_232>__1;
            internal int <$s_233>__2;
            internal System.Type <interfaze>__0;
            internal T <module>__4;
            internal System.Type <type>__3;
            internal Assembly assembly;
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                        ...
                        this.<$s_232>__1 = AssemblyHelper.GetTypesFromAssembly(this.assembly);
                        this.<$s_233>__2 = 0;
                        goto Label_0138;
            ...
            Label_012A:
                this.<$s_233>__2++;
            Label_0138:
                if (this.<$s_233>__2 < this.<$s_232>__1.Length)
                {
                    this.<type>__3 = this.<$s_232>__1[this.<$s_233>__2];
