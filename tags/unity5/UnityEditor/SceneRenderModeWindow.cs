namespace UnityEditor
{
    ...
    internal class SceneRenderModeWindow : PopupWindowContent
    {
        ...
        private static readonly int sRenderModeCount = (!Unsupported.IsDeveloperBuild() ? (Styles.sRenderModeOptions.Length - 2) : Styles.sRenderModeOptions.Length);
        ...
        private class Styles
        {
            ...
            public static readonly GUIContent[] sRenderModeOptions = new GUIContent[] { 
                ...
                EditorGUIUtility.TextContent("Irradiance"), EditorGUIUtility.TextContent("Directionality"), EditorGUIUtility.TextContent("Baked"), new GUIContent("Clustering [internal]"), new GUIContent("Lit Clustering [internal]")
             };
