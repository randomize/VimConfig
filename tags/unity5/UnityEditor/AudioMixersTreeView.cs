namespace UnityEditor
{
    ...
    internal class AudioMixersTreeView
    {
        ...
        public void OnGUI(Rect rect)
        {
            ...
            AudioMixerDrawUtils.DrawScrollDropShadow(rect3, this.m_TreeView.state.scrollPos.y, this.m_TreeView.gui.GetTotalSize(this.m_TreeView.data.GetVisibleRows()).y);
