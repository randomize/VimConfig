namespace UnityEditor
{
    ...
    public sealed class TextureImporter : AssetImporter
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall, Obsolete("DoesSourceTextureHaveColor always returns true in Unity.")]
        ...
        public UnityEngine.FilterMode filterMode { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
