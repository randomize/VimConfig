namespace UnityEditor
{
    ...
    public static class SceneModeUtility
    {
        ...
        public static T[] GetSelectedObjectsOfType<T>(out GameObject[] gameObjects, params System.Type[] types) where T: UnityEngine.Object
        {
            ...
            foreach (Transform transform in Selection.GetTransforms(UnityEditor.SelectionMode.Editable | UnityEditor.SelectionMode.ExcludePrefab))
            {
        ...
        {
            UnityEngine.Object[] objArray = Resources.FindObjectsOfTypeAll(typeof(SceneHierarchyWindow));
