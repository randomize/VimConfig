namespace UnityEditor
{
    ...
    internal sealed class AssetStorePreviewManager
    {
        ...
        {
            <SetupTextureDownload>c__AnonStorey51 storey;
            storey = new <SetupTextureDownload>c__AnonStorey51 {
                cached = cached,
                url = url,
            ...
            storey.client.doneCallback = new AsyncHTTPClient.DoneCallback(storey.<>m__87);
        ...
        [CompilerGenerated]
        private sealed class <SetupTextureDownload>c__AnonStorey51
        {
            internal AssetStorePreviewManager.CachedAssetStoreImage cached;
            internal AsyncHTTPClient client;
            internal string url;

            internal void <>m__87(AsyncHTTPClient c)
            {
