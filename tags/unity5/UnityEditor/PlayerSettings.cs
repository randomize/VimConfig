namespace UnityEditor
{
    ...
    public sealed class PlayerSettings : UnityEngine.Object
    {
        ...
        {
            <GetPlatformName>c__AnonStoreyF yf = new <GetPlatformName>c__AnonStoreyF {
                targetGroup = targetGroup
            };
            BuildPlayerWindow.BuildPlatform platform = BuildPlayerWindow.GetValidPlatforms().Find(new Predicate<BuildPlayerWindow.BuildPlatform>(yf.<>m__11));
        ...
        [CompilerGenerated]
        private sealed class <GetPlatformName>c__AnonStoreyF
        {
            internal BuildTargetGroup targetGroup;

            internal bool <>m__11(BuildPlayerWindow.BuildPlatform p)
            {
        ...
        public sealed class XboxOne
        {
            ...
            internal static void InitializeCapability(string capability, bool defaultVal)
            {
                PlayerSettings.InitializePropertyBool(capability, defaultVal, BuildTargetGroup.XboxOne);
            }
            ...
            internal static void InitializeSupportedLanguage(string language, bool defaultVal)
            {
                PlayerSettings.InitializePropertyBool(language, defaultVal, BuildTargetGroup.XboxOne);
            }
