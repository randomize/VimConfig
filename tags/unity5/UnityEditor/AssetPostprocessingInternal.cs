namespace UnityEditor
{
    ...
    internal class AssetPostprocessingInternal
    {
        ...
        {
            <AllPostProcessorMethodsNamed>c__AnonStorey29 storey = new <AllPostProcessorMethodsNamed>c__AnonStorey29 {
            ...
            return EditorAssemblies.SubclassesOf(typeof(AssetPostprocessor)).Select<System.Type, MethodInfo>(new Func<System.Type, MethodInfo>(storey.<>m__36)).Where<MethodInfo>(<>f__am$cache2);
        }
        ...
        private static uint[] GetAudioProcessorVersions()
        {
            ...
            IEnumerator<System.Type> enumerator = EditorAssemblies.SubclassesOf(typeof(AssetPostprocessor)).GetEnumerator();
            try
            {
                while (enumerator.MoveNext())
                {
                    ...
                    try
                    {
                        ...
                        System.Type type = postprocessor.GetType();
        ...
        [CompilerGenerated]
        private sealed class <AllPostProcessorMethodsNamed>c__AnonStorey29
        {
            internal string callbackName;

            internal MethodInfo <>m__36(System.Type assetPostprocessorClass)
            {
