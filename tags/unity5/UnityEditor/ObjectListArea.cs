namespace UnityEditor
{
    ...
    internal class ObjectListArea
    {
        ...
        public void BeginPing(int instanceID)
        {
            ...
            if (index != -1)
            {
                <BeginPing>c__AnonStorey35 storey = new <BeginPing>c__AnonStorey35();
                string fullText = null;
                storey.hierarchyProperty = new HierarchyProperty(HierarchyType.Assets);
                if (storey.hierarchyProperty.Find(instanceID, null))
                {
                    fullText = storey.hierarchyProperty.name;
                }
                if (fullText != null)
                {
                    ...
                    storey.label = content.text;
                    if (this.m_LocalAssets.ListMode)
                    {
                        <BeginPing>c__AnonStorey34 storey2 = new <BeginPing>c__AnonStorey34 {
                            <>f__ref$53 = storey
                        };
                        ...
                        this.m_Ping.m_ContentDraw = new Action<Rect>(storey2.<>m__41);
                    }
                    else
                    {
                        ...
                        this.m_Ping.m_ContentDraw = new Action<Rect>(storey.<>m__42);
                    }
        ...
        public bool BeginRename(float delay)
        {
            ...
            if (property.Find(instanceID, null) && !property.isMainRepresentation)
            {
                return false;
            }
            ...
            return this.GetRenameOverlay().BeginRename(property.name, instanceID, delay);
        }
        ...
        {
            <QueryAssetStore>c__AnonStorey31 storey = new <QueryAssetStore>c__AnonStorey31 {
                <>f__this = this
            };
            ...
            if (!this.m_ShowLocalAssetsOnly || this.ShowAssetStoreHitsWhileSearchingLocalAssets())
            {
                ...
                if (!this.m_QueryInProgress)
                {
                    ...
                    else
                    {
                        ...
                        AssetStoreResultBase<AssetStoreSearchResults>.Callback callback = new AssetStoreResultBase<AssetStoreSearchResults>.Callback(storey.<>m__3F);
        ...
        {
            IHierarchyProperty property = new HierarchyProperty(HierarchyType.Assets);
            if ((property.Find(instanceID, null) && property.Parent()) && !property.isFolder)
            {
                int num = property.instanceID;
                this.m_LocalAssets.ChangeExpandedState(num, true);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <BeginPing>c__AnonStorey34
        {
            internal ObjectListArea.<BeginPing>c__AnonStorey35 <>f__ref$53;
            internal FilteredHierarchy.FilterResult res;

            internal void <>m__41(Rect r)
            {
                ObjectListArea.LocalGroup.DrawIconAndLabel(r, this.res, this.<>f__ref$53.label, this.<>f__ref$53.hierarchyProperty.icon, false, false);
            }
        }

        [CompilerGenerated]
        private sealed class <BeginPing>c__AnonStorey35
        {
            internal HierarchyProperty hierarchyProperty;
            internal string label;

            internal void <>m__42(Rect r)
            {
        ...
        [CompilerGenerated]
        private sealed class <QueryAssetStore>c__AnonStorey31
        {
            internal ObjectListArea <>f__this;
            internal string queryFilter;

            internal void <>m__3F(AssetStoreSearchResults results)
            {
                ...
                else
                {
                    ...
                    this.<>f__this.m_Groups.Clear();
                    this.<>f__this.m_Groups.Add(this.<>f__this.m_LocalAssets);
                    <QueryAssetStore>c__AnonStorey32 storey = new <QueryAssetStore>c__AnonStorey32();
                    using (List<AssetStoreSearchResults.Group>.Enumerator enumerator2 = results.groups.GetEnumerator())
                    {
                        while (enumerator2.MoveNext())
                        {
                            ...
                            ObjectListArea.AssetStoreGroup item = this.<>f__this.m_StoreAssets.Find(new Predicate<ObjectListArea.AssetStoreGroup>(storey.<>m__43));
                            if (item == null)
                            {
                    ...
                    <QueryAssetStore>c__AnonStorey33 storey2 = new <QueryAssetStore>c__AnonStorey33();
                    using (List<string>.Enumerator enumerator3 = list.GetEnumerator())
                    {
                        while (enumerator3.MoveNext())
                        {
                            storey2.k = enumerator3.Current;
                            this.<>f__this.m_StoreAssets.RemoveAll(new Predicate<ObjectListArea.AssetStoreGroup>(storey2.<>m__44));
                        }
                    }
            ...
            private sealed class <QueryAssetStore>c__AnonStorey32
            {
                internal AssetStoreSearchResults.Group inGroup;

                internal bool <>m__43(ObjectListArea.AssetStoreGroup g)
                {
                    return (g.Name == this.inGroup.name);
                }
            }

            private sealed class <QueryAssetStore>c__AnonStorey33
            {
                internal string k;

                internal bool <>m__44(ObjectListArea.AssetStoreGroup g)
                {
