namespace UnityEditor
{
    ...
    public class AudioCurveRendering
    {
        ...
        {
            <DrawFilledCurve>c__AnonStorey52 storey = new <DrawFilledCurve>c__AnonStorey52 {
                curveColor = curveColor,
                eval = eval
            };
            DrawFilledCurve(r, new AudioCurveAndColorEvaluator(storey.<>m__88));
        }
        ...
        [CompilerGenerated]
        private sealed class <DrawFilledCurve>c__AnonStorey52
        {
            internal Color curveColor;
            internal AudioCurveRendering.AudioCurveEvaluator eval;

            internal float <>m__88(float x, out Color color)
            {
