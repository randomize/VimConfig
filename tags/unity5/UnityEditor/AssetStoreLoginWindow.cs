namespace UnityEditor
{
    ...
    internal class AssetStoreLoginWindow : EditorWindow
    {
        ...
        {
            <Login>c__AnonStorey50 storey = new <Login>c__AnonStorey50 {
                callback = callback,
            ...
            {
                AssetStoreClient.LoginWithRememberedSession(new AssetStoreClient.DoneLoginCallback(storey.<>m__85));
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <Login>c__AnonStorey50
        {
            internal AssetStoreLoginWindow.LoginCallback callback;
            internal string loginReason;

            internal void <>m__85(string errorMessage)
            {
