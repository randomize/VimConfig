namespace UnityEditor
{
    ...
    public sealed class FileUtil
    {
        ...
        {
            <CopyDirectoryFiltered>c__AnonStoreyC yc = new <CopyDirectoryFiltered>c__AnonStoreyC {
                exclude = null
            };
            try
            {
                ...
                {
                    yc.exclude = new Regex(regExExcludeFilter);
                }
            }
            ...
            Func<string, bool> includeCallback = new Func<string, bool>(yc.<>m__B);
        ...
        {
            <GetAllFilesRecursive>c__AnonStoreyD yd = new <GetAllFilesRecursive>c__AnonStoreyD {
            ...
            WalkFilesystemRecursively(path, new Action<string>(yd.<>m__C), <>f__am$cache1);
            return yd.files;
        }
        ...
        [CompilerGenerated]
        private sealed class <CopyDirectoryFiltered>c__AnonStoreyC
        {
            internal Regex exclude;

            internal bool <>m__B(string file)
            {
        ...
        [CompilerGenerated]
        private sealed class <GetAllFilesRecursive>c__AnonStoreyD
        {
            internal List<string> files;

            internal void <>m__C(string p)
            {
                this.files.Add(p);
            }
        }
