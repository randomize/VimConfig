namespace UnityEditor.Macros
{
    ...
    {
        [CompilerGenerated]
        private static Func<System.Type, bool> <>f__am$cache1;
        ...
        {
            <ExecuteMethodThroughReflection>c__AnonStorey93 storey = new <ExecuteMethodThroughReflection>c__AnonStorey93();
            ...
            MethodInfo method = EditorAssemblies.loadedAssemblies.Select<Assembly, System.Type>(new Func<Assembly, System.Type>(storey.<>m__1A8)).Where<System.Type>(<>f__am$cache1).First<System.Type>().GetMethod(name, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static);
            if (method == null)
            {
        ...
        [CompilerGenerated]
        private sealed class <ExecuteMethodThroughReflection>c__AnonStorey93
        {
            internal string typename;

            internal System.Type <>m__1A8(Assembly a)
            {
