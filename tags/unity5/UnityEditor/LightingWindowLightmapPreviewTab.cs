    ...
    internal class LightingWindowLightmapPreviewTab
    {
        ...
        public void Maps()
        {
            ...
            if (Lightmapping.giWorkflowMode == Lightmapping.GIWorkflowMode.OnDemand)
            {
                ...
                EditorGUILayout.PropertyField(obj2.FindProperty("m_LightmapSnapshot"), s_Styles.LightmapSnapshot, new GUILayoutOption[0]);
        ...
        {
            public GUIContent LightmapSnapshot = EditorGUIUtility.TextContent("Lightmap Snapshot|A different LightmapSnapshot.asset can be assigned here. These assets are generated by baking a scene in the OnDemand mode.");
