namespace UnityEditor.Scripting.Compilers
{
    ...
    internal class Cil2AsOutputParser : UnityScriptCompilerOutputParser
    {
        ...
        [CompilerGenerated]
        private sealed class <Parse>c__Iterator9 : IDisposable, IEnumerable, IEnumerator, IEnumerable<CompilerMessage>, IEnumerator<CompilerMessage>
        {
            internal CompilerMessage $current;
            internal int $PC;
            internal string[] <$>errorOutput;
            internal string[] <$s_1795>__2;
            internal int <$s_1796>__3;
            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    case 0:
                        ...
                        this.<$s_1795>__2 = this.errorOutput;
                        this.<$s_1796>__3 = 0;
                        goto Label_0103;
            ...
            Label_00F5:
                this.<$s_1796>__3++;
            Label_0103:
                if (this.<$s_1796>__3 < this.<$s_1795>__2.Length)
                {
                    this.<str>__4 = this.<$s_1795>__2[this.<$s_1796>__3];
