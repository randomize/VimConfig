    ...
    internal static class Weaver
    {
        ...
        Label_008C:
            ...
            try
            {
                ...
                if (!Unity.UNetWeaver.Program.Process(unityEngine, unityUNet, Path.GetDirectoryName(destPath), assemblies, list.ToArray(), assemblyResolver, new Action<string>(Debug.LogWarning), new Action<string>(Debug.LogError)))
                {
