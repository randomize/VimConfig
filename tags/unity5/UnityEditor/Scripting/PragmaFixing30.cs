namespace UnityEditor.Scripting
{
    ...
    internal class PragmaFixing30
    {
        ...
        [CompilerGenerated]
        private sealed class <SearchRecursive>c__Iterator8 : IDisposable, IEnumerable, IEnumerator, IEnumerable<string>, IEnumerator<string>
        {
            internal string $current;
            internal int $PC;
            internal string <$>dir;
            internal string <$>mask;
            internal string[] <$s_1771>__0;
            internal int <$s_1772>__1;
            internal IEnumerator<string> <$s_1773>__3;
            internal string[] <$s_1774>__5;
            internal int <$s_1775>__6;
            ...
            public void Dispose()
            {
                ...
                switch (num)
                {
                    case 1:
                        ...
                        {
                            if (this.<$s_1773>__3 == null)
                            {
                            }
                            this.<$s_1773>__3.Dispose();
                        }
                        break;
                }
            }
            ...
            public bool MoveNext()
            {
                ...
                {
                    case 0:
                        this.<$s_1771>__0 = Directory.GetDirectories(this.dir);
                        this.<$s_1772>__1 = 0;
                        goto Label_00EE;
            ...
            Label_0076:
                try
                {
                    while (this.<$s_1773>__3.MoveNext())
                    {
                        this.<f>__4 = this.<$s_1773>__3.Current;
                ...
                this.<$s_1772>__1++;
            Label_00EE:
                if (this.<$s_1772>__1 < this.<$s_1771>__0.Length)
                {
                    this.<d>__2 = this.<$s_1771>__0[this.<$s_1772>__1];
                    this.<$s_1773>__3 = PragmaFixing30.SearchRecursive(this.<d>__2, this.mask).GetEnumerator();
                    num = 0xfffffffd;
                    goto Label_0076;
                }
                this.<$s_1774>__5 = Directory.GetFiles(this.dir, this.mask);
                this.<$s_1775>__6 = 0;
                while (this.<$s_1775>__6 < this.<$s_1774>__5.Length)
                {
                    this.<f>__7 = this.<$s_1774>__5[this.<$s_1775>__6];
