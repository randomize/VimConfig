namespace UnityEditor.Scripting
{
    ...
    internal class APIUpdaterHelper
    {
        ...
        {
            bool flag;
            <IsReferenceToMissingObsoleteMember>c__AnonStorey9D storeyd = new <IsReferenceToMissingObsoleteMember>c__AnonStorey9D {
                className = className,
            ...
            try
            {
                ...
                {
                    <>f__am$cache0 = (Func<Assembly, IEnumerable<System.Type>>) (a => a.GetTypes());
                }
                flag = AppDomain.CurrentDomain.GetAssemblies().SelectMany<Assembly, System.Type>(<>f__am$cache0).FirstOrDefault<System.Type>(new Func<System.Type, bool>(storeyd.<>m__1CC)) != null;
            }
        ...
        [CompilerGenerated]
        private sealed class <IsReferenceToMissingObsoleteMember>c__AnonStorey9D
        {
            internal string className;
            internal string namespaceName;

            internal bool <>m__1CC(System.Type t)
            {
                return (((t.Name == this.className) && (t.Namespace == this.namespaceName)) && UnityEditor.Scripting.APIUpdaterHelper.IsUpdateable(t));
            }
        }
    }
}
