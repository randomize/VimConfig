namespace UnityEditor
{
    ...
    internal class SubModuleUI : ModuleUI
    {
        ...
        public override void OnInspectorGUI(ParticleSystem s)
        {
            ...
            UnityEngine.Object[] objArray1 = new UnityEngine.Object[,] { { this.m_SubEmitters[0, 0].objectReferenceValue, this.m_SubEmitters[0, 1].objectReferenceValue }, { this.m_SubEmitters[1, 0].objectReferenceValue, this.m_SubEmitters[1, 1].objectReferenceValue }, { this.m_SubEmitters[2, 0].objectReferenceValue, this.m_SubEmitters[2, 1].objectReferenceValue } };
            UnityEngine.Object[,] objArray = objArray1;
            for (int i = 0; i < 3; i++)
            {
            ...
            UnityEngine.Object[] objArray3 = new UnityEngine.Object[,] { { this.m_SubEmitters[0, 0].objectReferenceValue, this.m_SubEmitters[0, 1].objectReferenceValue }, { this.m_SubEmitters[1, 0].objectReferenceValue, this.m_SubEmitters[1, 1].objectReferenceValue }, { this.m_SubEmitters[2, 0].objectReferenceValue, this.m_SubEmitters[2, 1].objectReferenceValue } };
            UnityEngine.Object[,] objArray2 = objArray3;
            for (int j = 0; j < 3; j++)
            {
                for (int k = 0; k < 2; k++)
                {
