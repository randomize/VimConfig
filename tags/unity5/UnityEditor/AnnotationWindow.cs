namespace UnityEditor
{
    ...
    internal class AnnotationWindow : EditorWindow
    {
        ...
        {
            <GetAInfo>c__AnonStorey42 storey = new <GetAInfo>c__AnonStorey42 {
                scriptClass = scriptClass,
                classID = classID
            };
            if (storey.scriptClass != string.Empty)
            {
                return this.m_ScriptAnnotations.Find(new Predicate<AInfo>(storey.<>m__70));
            }
            return this.m_BuiltinAnnotations.Find(new Predicate<AInfo>(storey.<>m__71));
        }
        ...
        [CompilerGenerated]
        private sealed class <GetAInfo>c__AnonStorey42
        {
            internal int classID;
            internal string scriptClass;

            internal bool <>m__70(AInfo o)
            {
                return (o.m_ScriptClass == this.scriptClass);
            }

            internal bool <>m__71(AInfo o)
            {
