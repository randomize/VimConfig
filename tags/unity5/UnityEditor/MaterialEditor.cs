namespace UnityEditor
{
    ...
    public class MaterialEditor : Editor
    {
        ...
        protected override void OnHeaderGUI()
        {
            ...
            bool isExpanded = EditorGUI.DoObjectFoldout(controlID, position, base.targets, this.m_IsVisible);
            if (!this.forceVisible)
            {
                ...
                if (Event.current.type == EventType.Repaint)
                {
                    Rect rect2 = new Rect(position.xMin + 3f, position.yMax - 17f, 15f, 15f);
                    bool isHover = GUIUtility.hotControl == controlID;
                    EditorStyles.foldout.Draw(rect2, isHover, isHover, this.m_IsVisible, false);
                }
            }
        }
