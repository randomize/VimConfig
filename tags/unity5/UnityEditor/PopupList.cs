namespace UnityEditor
{
    ...
    internal class PopupList : PopupWindowContent
    {
        ...
        private void AdjustRecycledEditorSelectionToCompletion()
        {
            ...
            {
                s_RecycledEditor.content.text = this.m_EnteredTextCompletion;
        ...
        Label_017A:
            ...
            if ((GUI.Button(rect2, GUIContent.none, !(str2 != string.Empty) ? s_Styles.customTextFieldCancelButtonEmpty : s_Styles.customTextFieldCancelButton) && (str2 != string.Empty)) || flag4)
            {
                ...
                s_RecycledEditor.content.text = str3;
        ...
        public class InputData
        {
            ...
            {
                <BuildQuery>c__AnonStorey37 storey = new <BuildQuery>c__AnonStorey37 {
                    prefix = prefix
                };
                if (storey.prefix == string.Empty)
                {
                    return this.m_ListElements;
                }
                return this.m_ListElements.Where<PopupList.ListElement>(new Func<PopupList.ListElement, bool>(storey.<>m__4F));
            }
            ...
            [CompilerGenerated]
            private sealed class <BuildQuery>c__AnonStorey37
            {
                internal string prefix;

                internal bool <>m__4F(PopupList.ListElement element)
                {
