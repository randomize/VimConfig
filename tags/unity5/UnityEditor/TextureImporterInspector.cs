namespace UnityEditor
{
    ...
    internal class TextureImporterInspector : AssetImporterInspector
    {
        ...
        public TextureImporterInspector()
        {
            ...
            this.m_FilterModeOptions = (int[]) Enum.GetValues(typeof(UnityEngine.FilterMode));
        }
        ...
        private void PreviewableGUI()
        {
            ...
            if (((intValue != UnityEngine.FilterMode.Point) && ((this.m_EnableMipMap.intValue > 0) || (this.textureType == TextureImporterType.Advanced))) && (this.textureType != TextureImporterType.Sprite))
            {
                EditorGUI.BeginChangeCheck();
        ...
        protected class PlatformSetting
        {
            ...
            public PlatformSetting(string name, BuildTarget target, TextureImporterInspector inspector)
            {
                ...
                {
                    <>f__am$cacheD = new Func<UnityEngine.Object, TextureImporter>(TextureImporterInspector.PlatformSetting.<PlatformSetting>m__114);
                }
                this.m_Importers = inspector.targets.Select<UnityEngine.Object, TextureImporter>(<>f__am$cacheD).ToArray<TextureImporter>();
            ...
            [CompilerGenerated]
            private static TextureImporter <PlatformSetting>m__114(UnityEngine.Object x)
            {
        ...
        private class Styles
        {
            ...
            public Styles()
            {
                ...
                this.linearTexture = EditorGUIUtility.TextContent("Bypass sRGB Sampling|Texture will not be converted from gamma space to linear when sampled. Enable for GUI textures, look up textures and similar.");
                ...
                this.spriteModeOptions = new GUIContent[] { EditorGUIUtility.TextContent("Single"), EditorGUIUtility.TextContent("Multiple") };
                this.spriteModeOptionsAdvanced = new GUIContent[] { EditorGUIUtility.TextContent("None"), EditorGUIUtility.TextContent("Single"), EditorGUIUtility.TextContent("Multiple") };
