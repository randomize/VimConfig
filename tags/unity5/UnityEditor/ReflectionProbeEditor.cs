namespace UnityEditor
{
    ...
    internal class ReflectionProbeEditor : Editor
    {
        ...
        private bool sceneViewEditing
        {
            get
            {
                return (this.IsReflectionProbeEditMode(UnityEditorInternal.EditMode.editMode) && UnityEditorInternal.EditMode.IsOwner(this));
            }
        }
        ...
        private static class Styles
        {
            ...
            public static GUIContent blendDistanceText = new GUIContent("Blend Distance", "Area around the probe where it is blended with other probes. Only used in deferred shading.");
            ...
            static Styles()
            {
                ...
                {
                    <>f__am$cache22 = new Func<int, GUIContent>(ReflectionProbeEditor.Styles.<renderTextureSizes>m__185);
                }
            ...
            [CompilerGenerated]
            private static GUIContent <renderTextureSizes>m__185(int n)
            {
