namespace UnityEditor
{
    ...
    internal class AssetStoreAssetInspector : Editor
    {
        ...
        {
            <LoginAndImport>c__AnonStorey76 storey = new <LoginAndImport>c__AnonStorey76 {
                asset = asset
            };
            AssetStoreLoginWindow.Login("Please login to the Asset Store in order to get download information for the package.", new AssetStoreLoginWindow.LoginCallback(storey.<>m__11B));
        }
        ...
        [CompilerGenerated]
        private sealed class <LoginAndImport>c__AnonStorey76
        {
            internal AssetStoreAsset asset;

            internal void <>m__11B(string errorMessage)
            {
                if (errorMessage == null)
                {
