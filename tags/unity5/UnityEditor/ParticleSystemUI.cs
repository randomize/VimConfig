namespace UnityEditor
{
    ...
    internal class ParticleSystemUI
    {
        ...
        {
            int num = 0;
            ModuleUI[] euiArray1 = new ModuleUI[0x11];
            ...
            euiArray1[5] = new ForceModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[6] = new ColorModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[7] = new ColorByVelocityModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[8] = new SizeModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[9] = new SizeByVelocityModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[10] = new RotationModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[11] = new RotationByVelocityModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[12] = new ExternalForcesModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[13] = new CollisionModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[14] = new SubModuleUI(e, so, s_ModuleNames[num++]);
            euiArray1[15] = new UVModuleUI(e, so, s_ModuleNames[num++]);
            return euiArray1;
        }
        ...
        {
            return new string[] { 
                string.Empty, "Emission", "Shape", "Velocity over Lifetime", "Limit Velocity over Lifetime", "Force over Lifetime", "Color over Lifetime", "Color by Speed", "Size over Lifetime", "Size by Speed", "Rotation over Lifetime", "Rotation by Speed", "External Forces", "Collision", "Sub Emitters", "Texture Sheet Animation", 
                "Renderer"
             };
        }
