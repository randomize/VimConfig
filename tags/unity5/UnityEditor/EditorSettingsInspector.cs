namespace UnityEditor
{
    ...
    internal class EditorSettingsInspector : Editor
    {
        ...
        {
            <OnInspectorGUI>c__AnonStorey7E storeye = new <OnInspectorGUI>c__AnonStorey7E();
            ...
            GUI.enabled = enabled;
            storeye.selvc = EditorSettings.externalVersionControl;
            int index = Array.FindIndex<PopupElement>(this.vcPopupList, new Predicate<PopupElement>(storeye.<>m__132));
            if (index < 0)
            {
                index = 0;
            }
            ...
            {
                <OnInspectorGUI>c__AnonStorey7F storeyf = new <OnInspectorGUI>c__AnonStorey7F();
                GUI.enabled = true;
                bool flag2 = false;
                ...
                storeyf.logLevel = EditorUserSettings.GetConfigValue("vcSharedLogLevel");
                int num3 = Array.FindIndex<string>(this.logLevelPopupList, new Predicate<string>(storeyf.<>m__133));
                if (num3 == -1)
                {
                    storeyf.logLevel = "info";
                }
        ...
        [CompilerGenerated]
        private sealed class <OnInspectorGUI>c__AnonStorey7E
        {
            internal ExternalVersionControl selvc;

            internal bool <>m__132(EditorSettingsInspector.PopupElement cand)
            {
        ...
        [CompilerGenerated]
        private sealed class <OnInspectorGUI>c__AnonStorey7F
        {
            internal string logLevel;

            internal bool <>m__133(string item)
            {
