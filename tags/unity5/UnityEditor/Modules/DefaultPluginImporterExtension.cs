namespace UnityEditor.Modules
{
    ...
    internal class DefaultPluginImporterExtension : IPluginImporterExtension
    {
        ...
        {
            <GetCompatiblePlugins>c__AnonStorey71 storey = new <GetCompatiblePlugins>c__AnonStorey71 {
                buildTargetName = buildTargetName
            };
            PluginImporter[] importerArray = PluginImporter.GetAllImporters().Where<PluginImporter>(new Func<PluginImporter, bool>(storey.<>m__100)).ToArray<PluginImporter>();
        ...
        [CompilerGenerated]
        private sealed class <GetCompatiblePlugins>c__AnonStorey71
        {
            internal string buildTargetName;

            internal bool <>m__100(PluginImporter imp)
            {
