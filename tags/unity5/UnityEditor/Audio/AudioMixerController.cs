namespace UnityEditor.Audio
{
    ...
    internal sealed class AudioMixerController : AudioMixer
    {
        ...
        [CompilerGenerated]
        private static Func<UnityEngine.Object, AudioMixerGroupController> <>f__am$cacheB;
        ...
        {
            <AreAnyOfTheGroupsInTheListAncestors>c__AnonStorey20 storey = new <AreAnyOfTheGroupsInTheListAncestors>c__AnonStorey20 {
                groups = groups,
                <>f__this = this
            };
            return storey.groups.Any<AudioMixerGroupController>(new Func<AudioMixerGroupController, bool>(storey.<>m__26));
        }
        ...
        {
            <ContainsExposedParameter>c__AnonStorey1E storeye = new <ContainsExposedParameter>c__AnonStorey1E {
                parameter = parameter
            };
            return (this.exposedParameters.Where<ExposedAudioParameter>(new Func<ExposedAudioParameter, bool>(storeye.<>m__24)).ToArray<ExposedAudioParameter>().Length > 0);
        }
        ...
        {
            <GetCurrentViewGroupList>c__AnonStorey23 storey = new <GetCurrentViewGroupList>c__AnonStorey23();
            List<AudioMixerGroupController> allAudioGroupsSlow = this.GetAllAudioGroupsSlow();
            storey.view = this.views[this.currentViewIndex];
            return allAudioGroupsSlow.Where<AudioMixerGroupController>(new Func<AudioMixerGroupController, bool>(storey.<>m__2C)).ToArray<AudioMixerGroupController>();
        }
        ...
        public void OnUnitySelectionChanged()
        {
            ...
            this.m_CachedSelection = allAudioGroupsSlow.Intersect<AudioMixerGroupController>(filtered.Select<UnityEngine.Object, AudioMixerGroupController>(<>f__am$cacheB)).ToList<AudioMixerGroupController>();
        }

        private void RemoveAncestorGroups(List<AudioMixerGroupController> groups)
        {
            <RemoveAncestorGroups>c__AnonStorey21 storey = new <RemoveAncestorGroups>c__AnonStorey21 {
                groups = groups,
                <>f__this = this
            };
            storey.groups.RemoveAll(new Predicate<AudioMixerGroupController>(storey.<>m__27));
            object.Equals(this.AreAnyOfTheGroupsInTheListAncestors(storey.groups), false);
        }
        ...
        {
            <RemoveExposedParameter>c__AnonStorey1F storeyf = new <RemoveExposedParameter>c__AnonStorey1F {
                parameter = parameter
            };
            this.exposedParameters = this.exposedParameters.Where<ExposedAudioParameter>(new Func<ExposedAudioParameter, bool>(storeyf.<>m__25)).ToArray<ExposedAudioParameter>();
            this.OnChangedExposedParameter();
            if (this.exposedParamCache.ContainsKey(storeyf.parameter))
            {
                this.exposedParamCache.Remove(storeyf.parameter);
            }
            AudioMixerUtility.RepaintAudioMixerAndInspectors();
        }
        ...
        {
            <SanitizeGroupViews>c__AnonStorey22 storey = new <SanitizeGroupViews>c__AnonStorey22 {
        ...
        [CompilerGenerated]
        private sealed class <AreAnyOfTheGroupsInTheListAncestors>c__AnonStorey20
        {
            internal AudioMixerController <>f__this;
            internal List<AudioMixerGroupController> groups;

            internal bool <>m__26(AudioMixerGroupController g)
            {
        ...
        [CompilerGenerated]
        private sealed class <ContainsExposedParameter>c__AnonStorey1E
        {
            internal GUID parameter;

            internal bool <>m__24(ExposedAudioParameter val)
            {
        ...
        [CompilerGenerated]
        private sealed class <GetCurrentViewGroupList>c__AnonStorey23
        {
            internal MixerGroupView view;

            internal bool <>m__2C(AudioMixerGroupController g)
            {
        ...
        [CompilerGenerated]
        private sealed class <RemoveAncestorGroups>c__AnonStorey21
        {
            internal AudioMixerController <>f__this;
            internal List<AudioMixerGroupController> groups;

            internal bool <>m__27(AudioMixerGroupController g)
            {
                return this.<>f__this.IsChildOf(g, this.groups);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <RemoveExposedParameter>c__AnonStorey1F
        {
            internal GUID parameter;

            internal bool <>m__25(ExposedAudioParameter val)
            {
                return (val.guid != this.parameter);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <SanitizeGroupViews>c__AnonStorey22
        {
            internal List<AudioMixerGroupController> allGroups;

            internal IEnumerable<AudioMixerGroupController> <>m__28(GUID x)
            {
