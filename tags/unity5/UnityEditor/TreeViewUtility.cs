namespace UnityEditor
{
    ...
    internal static class TreeViewUtility
    {
        ...
        {
            <FindItemInList>c__AnonStorey70<T> storey = new <FindItemInList>c__AnonStorey70<T> {
                id = id
            };
            return treeViewItems.FirstOrDefault<T>(new Func<T, bool>(storey.<>m__FD));
        }
        ...
        {
            <FindItemsInList>c__AnonStorey6F storeyf = new <FindItemsInList>c__AnonStorey6F {
                itemIDs = itemIDs
            };
            return treeViewItems.Where<TreeViewItem>(new Func<TreeViewItem, bool>(storeyf.<>m__FC)).ToList<TreeViewItem>();
        }
        ...
        [CompilerGenerated]
        private sealed class <FindItemInList>c__AnonStorey70<T> where T: TreeViewItem
        {
            internal int id;

            internal bool <>m__FD(T t)
            {
                return (t.id == this.id);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <FindItemsInList>c__AnonStorey6F
        {
            internal IEnumerable<int> itemIDs;

            internal bool <>m__FC(TreeViewItem x)
            {
