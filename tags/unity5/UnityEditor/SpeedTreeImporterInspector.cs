namespace UnityEditor
{
    ...
    internal class SpeedTreeImporterInspector : AssetImporterInspector
    {
        ...
        {
            <GetLODInfoArray>c__AnonStorey73 storey = new <GetLODInfoArray>c__AnonStorey73 {
                <>f__this = this,
                lodCount = this.m_LODSettings.arraySize
            };
            return LODGroupGUI.CreateLODInfos(storey.lodCount, area, new Func<int, string>(storey.<>m__109), new Func<int, float>(storey.<>m__10A));
        }
