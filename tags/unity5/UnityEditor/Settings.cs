namespace UnityEditor
{
    ...
    internal class Settings
    {
        ...
        [CompilerGenerated]
        private sealed class <Prefs>c__Iterator4<T> : IDisposable, IEnumerable, IEnumerator, IEnumerable<KeyValuePair<string, T>>, IEnumerator<KeyValuePair<string, T>> where T: IPrefType
        {
            internal KeyValuePair<string, T> $current;
            internal int $PC;
            internal IEnumerator<KeyValuePair<string, object>> <$s_427>__0;
            ...
            public void Dispose()
            {
                ...
                switch (num)
                {
                    case 1:
                        ...
                        {
                            if (this.<$s_427>__0 == null)
                            {
                            }
                            this.<$s_427>__0.Dispose();
                        }
                        break;
                }
            }
            ...
            public bool MoveNext()
            {
                ...
                {
                    case 0:
                        this.<$s_427>__0 = Settings.m_Prefs.GetEnumerator();
                        num = 0xfffffffd;
                        break;
                ...
                try
                {
                    while (this.<$s_427>__0.MoveNext())
                    {
                        this.<kvp>__1 = this.<$s_427>__0.Current;
