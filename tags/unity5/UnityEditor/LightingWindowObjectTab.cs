namespace UnityEditor
{
    ...
    internal class LightingWindowObjectTab
    {
        ...
        private class Styles
        {
            ...
            public GUIContent PreserveUVs = EditorGUIUtility.TextContent("Preserve UVs|Preserve the incoming lightmap UVs. The incoming UVs are packed but charts are not scaled or merged. This is necessary for correct edge stitching of axis aligned chart edges.");
