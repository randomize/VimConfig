        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((base.isVisible && !property.hasMultipleDifferentValues) && (property.objectReferenceValue != null))
            {
                ...
                if (property3 != null)
                {
                    ...
                    IEnumerable<bool> enumerable = base.targets.Select<UnityEngine.Object, bool>(<>f__am$cache3);
                ...
                IEnumerable<bool> enumerable2 = base.targets.Select<UnityEngine.Object, bool>(<>f__am$cache5);
