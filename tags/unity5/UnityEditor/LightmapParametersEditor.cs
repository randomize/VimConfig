namespace UnityEditor
{
    ...
    internal class LightmapParametersEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label(Styles.precomputedRealtimeGIContent, EditorStyles.boldLabel, new GUILayoutOption[0]);
            EditorGUILayout.PropertyField(this.m_Resolution, Styles.resolutionContent, new GUILayoutOption[0]);
            EditorGUILayout.Slider(this.m_ClusterResolution, 0.1f, 1f, Styles.clusterResolutionContent, new GUILayoutOption[0]);
            EditorGUILayout.IntSlider(this.m_IrradianceBudget, 0x20, 0x800, Styles.irradianceBudgetContent, new GUILayoutOption[0]);
            EditorGUILayout.IntSlider(this.m_IrradianceQuality, 0x200, 0x20000, Styles.irradianceQualityContent, new GUILayoutOption[0]);
            EditorGUILayout.Slider(this.m_BackFaceTolerance, 0f, 1f, Styles.backFaceToleranceContent, new GUILayoutOption[0]);
            EditorGUILayout.Slider(this.m_ModellingTolerance, 0f, 1f, Styles.modellingToleranceContent, new GUILayoutOption[0]);
            EditorGUILayout.PropertyField(this.m_EdgeStitching, Styles.edgeStitchingContent, new GUILayoutOption[0]);
