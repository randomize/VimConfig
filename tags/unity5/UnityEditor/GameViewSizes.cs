namespace UnityEditor
{
    ...
    internal class GameViewSizes : ScriptableSingleton<GameViewSizes>
    {
        ...
        static GameViewSizes()
        {
            ...
            {
                <>f__am$cache11 = new System.Action(GameViewSizes.<GameViewSizes>m__EA);
            }
            EditorUserBuildSettings.activeBuildTargetChanged = (System.Action) Delegate.Combine(EditorUserBuildSettings.activeBuildTargetChanged, <>f__am$cache11);
        }

        [CompilerGenerated]
        private static void <GameViewSizes>m__EA()
        {
            RefreshGameViewSizeGroupType();
        }
