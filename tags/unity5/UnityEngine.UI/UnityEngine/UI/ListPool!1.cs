namespace UnityEngine.UI
{
    ...
    internal static class ListPool<T>
    {
        ...
        static ListPool()
        {
            ...
            {
                ListPool<T>.<>f__am$cache1 = new UnityAction<List<T>>(ListPool<T>.<s_ListPool>m__15);
            }
            ListPool<T>.s_ListPool = new ObjectPool<List<T>>(null, ListPool<T>.<>f__am$cache1);
        }

        [CompilerGenerated]
        private static void <s_ListPool>m__15(List<T> l)
        {
            l.Clear();
        }
