namespace UnityEngine
{
    ...
    public sealed class Application
    {
        ...
        public static int loadedLevel { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }

        public static string loadedLevelName { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; }
