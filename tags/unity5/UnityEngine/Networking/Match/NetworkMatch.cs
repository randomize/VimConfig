            ...
            public bool MoveNext()
            {
                ...
                switch (num)
                {
                    ...
                    case 1:
                        ...
                        {
                            UnityEngine.Debug.LogError("Request error: " + this.client.error);
                            UnityEngine.Debug.LogError("Raw response: " + this.client.text);
                            break;
                        }
                        if (SimpleJson.SimpleJson.TryDeserializeObject(this.client.text, out this.<o>__1))
                        {
                            ...
                            if (this.<dictJsonObj>__2 != null)
                            {
                                ...
                                catch (FormatException exception)
                                {
                                    ...
                                    UnityEngine.Debug.Log(this.<exception>__3);
                                }
                            }
                        }
                        if (this.<jsonInterface>__0 == null)
                        {
                            UnityEngine.Debug.LogError("Could not parse: " + this.client.text);
                        }
                        else
                        {
                            UnityEngine.Debug.Log("JSON Response: " + this.<jsonInterface>__0.ToString());
                        }
                        break;
