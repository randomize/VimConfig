    ...
    public class TextEditor
    {
        ...
        public void Copy()
        {
            if ((this.selectIndex != this.cursorIndex) && !this.isPasswordField)
            {
                ...
                {
                    str = this.content.text.Substring(this.cursorIndex, this.selectIndex - this.cursorIndex);
                }
                else
                {
                    str = this.content.text.Substring(this.selectIndex, this.cursorIndex - this.selectIndex);
                }
        ...
        public bool DeleteLineBack()
        {
            ...
            {
                this.content.text = this.content.text.Remove(cursorIndex, this.cursorIndex - cursorIndex);
        ...
        public bool DeleteWordBack()
        {
            ...
            {
                this.content.text = this.content.text.Remove(startIndex, this.cursorIndex - startIndex);
                int num2 = startIndex;
        ...
        private int IndexOfEndOfLine(int startIndex)
        {
            ...
            return ((index == -1) ? this.content.text.Length : index);
        }
        ...
        {
            int b = this.style.GetCursorStringIndex(this.position, this.content, cursorPosition + this.scrollOffset);
            this.m_iAltCursorPos = Mathf.Min(this.content.text.Length, b);
        ...
        public void MoveParagraphBackward()
        {
            ...
            {
                num = this.content.text.LastIndexOf('\n', this.cursorIndex - 2) + 1;
                this.cursorIndex = num;
                this.selectIndex = num;
            }
            else
