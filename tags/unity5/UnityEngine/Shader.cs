namespace UnityEngine
{
    ...
    public sealed class Shader : UnityEngine.Object
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall, Obsolete("SetGlobalTextureMatrixName is not supported anymore. Use programmable shaders to achieve the same effect.", true)]
