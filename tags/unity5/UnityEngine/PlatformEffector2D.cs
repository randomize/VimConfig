namespace UnityEngine
{
    ...
    public sealed class PlatformEffector2D : Effector2D
    {
        ...
        [Obsolete("PlatformEffector2D.sideAngleVariance has been deprecated. Platform sides are now calculated automatically.", true)]
        public float sideAngleVariance { [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] get; [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall] set; }
