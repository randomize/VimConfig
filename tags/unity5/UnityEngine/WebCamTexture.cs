namespace UnityEngine
{
    ...
    public sealed class WebCamTexture : Texture
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall), WrapperlessIcall, Obsolete("since Unity 5.0 iOS WebCamTexture always goes through CVTextureCache and is read to memory on-demand")]
