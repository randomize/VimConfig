namespace UnityEngineInternal
{
    ...
    public sealed class APIUpdaterRuntimeServices
    {
        ...
        static APIUpdaterRuntimeServices()
        {
            ...
            ComponentsFromUnityEngine = type.Assembly.GetTypes().Where<System.Type>(new Func<System.Type, bool>(type.IsAssignableFrom)).ToList<System.Type>();
        }
        ...
        {
            <ResolveType>c__AnonStorey6 storey = new <ResolveType>c__AnonStorey6 {
                name = name
            };
            System.Type type = ComponentsFromUnityEngine.FirstOrDefault<System.Type>(new Func<System.Type, bool>(storey.<>m__7));
            if (type != null)
            {
            ...
            {
                <>f__am$cache1 = (Func<Assembly, IEnumerable<System.Type>>) (a => a.GetTypes());
            }
            type2 = AppDomain.CurrentDomain.GetAssemblies().SelectMany<Assembly, System.Type>(<>f__am$cache1).SingleOrDefault<System.Type>(new Func<System.Type, bool>(storey.<>m__9));
            if (type2 != null)
            {
        ...
        [CompilerGenerated]
        private sealed class <ResolveType>c__AnonStorey6
        {
            internal string name;

            internal bool <>m__7(System.Type t)
            {
                return (((t.Name == this.name) || (t.FullName == this.name)) && !APIUpdaterRuntimeServices.IsMarkedAsObsolete(t));
            }

            internal bool <>m__9(System.Type t)
            {
