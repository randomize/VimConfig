namespace System
{
    ...
    internal class Number
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern unsafe bool NumberBufferToDouble(byte* number, ref double value);
        ...
        private static unsafe bool TryStringToNumber(string str, NumberStyles options, ref NumberBuffer number, NumberFormatInfo numfmt, bool parseDecimal)
        {
            if (str == null)
            {
                return false;
            ...
            fixed (char* str2 = ((char*) str))
            {
                char* chPtr = str2;
                char* chPtr2 = chPtr;
                if (!ParseNumber(ref chPtr2, options, ref number, numfmt, parseDecimal) || ((((long) ((chPtr2 - chPtr) / 2)) < str.Length) && !TrailingZeros(str, (int) ((long) ((chPtr2 - chPtr) / 2)))))
                {
                    return false;
                }
            }
