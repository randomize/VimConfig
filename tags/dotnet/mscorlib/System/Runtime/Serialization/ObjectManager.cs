namespace System.Runtime.Serialization
{
    ...
    public class ObjectManager
    {
        ...
        private static Type[] SIConstructorTypes = new Type[] { typeof(SerializationInfo), typeof(StreamingContext) };
        private static Type[] SIWindowsIdentityConstructorTypes = new Type[] { typeof(SerializationInfo) };
        private static Type TypeOfWindowsIdentity = typeof(WindowsIdentity);
        ...
        internal void CompleteISerializableObject(object obj, SerializationInfo info, StreamingContext context)
        {
            ...
            {
                throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_ConstructorNotFound"), new object[] { t }), exception);
            }
        ...
        {
            RuntimeConstructorInfo info = (RuntimeConstructorInfo) t.Cache[CacheObjType.ConstructorInfo];
            if (info == null)
            {
                RuntimeType type = (RuntimeType) t;
                info = type.GetConstructor(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance, null, CallingConventions.Any, ctorParams, null) as RuntimeConstructorInfo;
                if (info == null)
                {
                ...
                t.Cache[CacheObjType.ConstructorInfo] = info;
            }
            return info;
        }
