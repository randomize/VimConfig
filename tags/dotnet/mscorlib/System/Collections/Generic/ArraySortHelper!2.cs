namespace System.Collections.Generic
{
    ...
    internal class ArraySortHelper<TKey, TValue> : IArraySortHelper<TKey, TValue>
    {
        ...
        public static IArraySortHelper<TKey, TValue> CreateArraySortHelper()
        {
            ...
            {
                RuntimeTypeHandle[] inst = new RuntimeTypeHandle[] { typeof(TKey).TypeHandle, typeof(TValue).TypeHandle };
                ArraySortHelper<TKey, TValue>.defaultArraySortHelper = (IArraySortHelper<TKey, TValue>) typeof(GenericArraySortHelper<string, string>).TypeHandle.Instantiate(inst).Allocate();
            }
            else
            {
