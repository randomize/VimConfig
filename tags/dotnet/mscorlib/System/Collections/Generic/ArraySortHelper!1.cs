namespace System.Collections.Generic
{
    ...
    internal class ArraySortHelper<T> : IArraySortHelper<T>
    {
        ...
        private static IArraySortHelper<T> CreateArraySortHelper()
        {
            ...
            {
                RuntimeTypeHandle[] inst = new RuntimeTypeHandle[] { typeof(T).TypeHandle };
                ArraySortHelper<T>.defaultArraySortHelper = (IArraySortHelper<T>) typeof(GenericArraySortHelper<string>).TypeHandle.Instantiate(inst).Allocate();
            }
            else
            {
