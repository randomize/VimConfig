    ...
    public class MissingMemberException : MemberAccessException, ISerializable
    {
        ...
        public override string Message
        {
            get
            {
                ...
                return string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("MissingMember_Name", new object[] { this.ClassName + "." + this.MemberName + ((this.Signature != null) ? (" " + FormatSignature(this.Signature)) : "") }), new object[0]);
            }
        }
    }
}
