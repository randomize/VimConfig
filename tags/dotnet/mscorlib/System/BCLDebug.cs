namespace System
{
    ...
    internal static class BCLDebug
    {
        ...
        private static readonly SwitchStructure[] switches = new SwitchStructure[] { new SwitchStructure("NLS", 1), new SwitchStructure("SER", 2), new SwitchStructure("DYNIL", 4), new SwitchStructure("REMOTE", 8), new SwitchStructure("BINARY", 0x10), new SwitchStructure("SOAP", 0x20), new SwitchStructure("REMOTINGCHANNELS", 0x40), new SwitchStructure("CACHE", 0x80), new SwitchStructure("RESMGRFILEFORMAT", 0x100), new SwitchStructure("PERF", 0x200), new SwitchStructure("CORRECTNESS", 0x400), new SwitchStructure("MEMORYFAILPOINT", 0x800) };
