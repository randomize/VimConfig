namespace System
{
    ...
    public sealed class TypeInitializationException : SystemException
    {
        ...
        public TypeInitializationException(string fullTypeName, Exception innerException) : base(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("TypeInitialization_Type"), new object[] { fullTypeName }), innerException)
        {
