namespace System.Globalization
{
    ...
    public class GregorianCalendar : Calendar
    {
        ...
        public override bool IsLeapDay(int year, int month, int day, int era)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("day", string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_Range"), new object[] { 1, this.GetDaysInMonth(year, month) }));
            }
