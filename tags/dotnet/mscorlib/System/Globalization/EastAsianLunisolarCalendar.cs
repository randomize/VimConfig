namespace System.Globalization
{
    ...
    public abstract class EastAsianLunisolarCalendar : Calendar
    {
        ...
        internal int CheckYearRange(int year, int era)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("year", string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_Range"), new object[] { this.MinEraCalendarYear(era), this.MaxEraCalendarYear(era) }));
            }
            return year;
        }
        ...
        internal void GregorianToLunar(int nSYear, int nSMonth, int nSDate, ref int nLYear, ref int nLMonth, ref int nLDate)
        {
            int num7;
            int num8;
            int num = (this.GergIsleap(nSYear) == 1) ? DaysToMonth366[nSMonth - 1] : DaysToMonth365[nSMonth - 1];
            num += nSDate;
            int num2 = num;
            nLYear = nSYear;
            ...
            {
                nLYear--;
                num2 += (this.GergIsleap(nLYear) == 1) ? 0x16e : 0x16d;
        ...
        internal bool LunarToGregorian(int nLYear, int nLMonth, int nLDate, ref int nSolarYear, ref int nSolarMonth, ref int nSolarDay)
        {
            ...
            int num5 = this.GergIsleap(nLYear);
        ...
        public override int TwoDigitYearMax
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("value", string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("ArgumentOutOfRange_Range"), new object[] { 0x63, this.MaxCalendarYear }));
                }
